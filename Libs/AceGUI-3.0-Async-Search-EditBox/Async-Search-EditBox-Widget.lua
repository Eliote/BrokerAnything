--[[
	This widget is an asynchronous version of the Search-Editbox-Widget from
	"https://www.wowace.com/projects/acegui-3-0-search-editbox"
--]]
...
do
	...
	local function Predictor_Reset(self, object)
		...
		if (listener.OnCancel) then listener:OnCancel() end
	...
	local function OnSuccess(self, result)
		...
		self.predictor.activeButtons = activeButtons
	end
	...
	local function Predictor_Query(self, object)
		...
		Fire(self.obj, "GetValues", self.obj.editBox:GetText(), PREDICTOR_ROWS, listener)
	end
	-- }}
	...
	local function Constructor()
		...
		local editBox = CreateFrame("EditBox", "AceGUI30AsyncSearchEditBox" .. num, frame, "InputBoxTemplate")
...
do
	local MAJOR, MINOR = "AceGUI-3.0-Async-Search-EditBox", 1
	...
	local function Constructor(options)
		local self = AceGUI:Create("AsyncSearchEditBox_Base")
